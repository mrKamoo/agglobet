                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select name="round" id="round" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="Phase de groupes" {{ old('round', $game->round) === 'Phase de groupes' ? 'selected' : '' }}>Phase de groupes</option>
                                        <option value="16es de finale" {{ old('round', $game->round) === '16es de finale' ? 'selected' : '' }}>16es de finale</option>
                                        <option value="8es de finale" {{ old('round', $game->round) === '8es de finale' ? 'selected' : '' }}>8es de finale</option>
                                        <option value="Quarts de finale" {{ old('round', $game->round) === 'Quarts de finale' ? 'selected' : '' }}>Quarts de finale</option>
                                        <option value="Demi-finale" {{ old('round', $game->round) === 'Demi-finale' ? 'selected' : '' }}>Demi-finale</option>
                                        <option value="Match pour la 3e place" {{ old('round', $game->round) === 'Match pour la 3e place' ? 'selected' : '' }}>Match pour la 3e place</option>
                                        <option value="Finale" {{ old('round', $game->round) === 'Finale' ? 'selected' : '' }}>Finale</option>
                                    </select>
                                    @error('round')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="group" id="group" value="{{ old('group', $game->group) }}" maxlength="2" placeholder="Ex: A" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 uppercase">
                                    @error('group')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="stadium" id="stadium" value="{{ old('stadium', $game->stadium) }}" placeholder="Ex: MetLife Stadium, New York" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('stadium')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
