    ...
    <div class="py-12">
        <div id="app" class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="{{ route('chat') }}" class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow text-center group">
                    <div class="w-10 h-10 mx-auto bg-purple-50 text-purple-600 rounded-full flex items-center justify-center mb-2 group-hover:bg-purple-100">
