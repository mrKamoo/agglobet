                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex-1 text-center">
                                                @if($game->homeTeam->logo)
                                                    <img src="{{ $game->homeTeam->logo }}" alt="{{ $game->homeTeam->name }}" class="mx-auto h-10 w-10 object-contain mb-2">
                                                @endif
                                            ...
                                            <div class="flex-1 text-center">
                                                @if($game->awayTeam->logo)
                                                    <img src="{{ $game->awayTeam->logo }}" alt="{{ $game->awayTeam->name }}" class="mx-auto h-10 w-10 object-contain mb-2">
                                                @endif
